...
// app.get('/', (req, res) => res.send(`LP BOT SIAP DIGUNAKAN... BOT BY ©LKS Project`))

// app.listen(port, () =>
// console.log(`Aplikasi kamu berjalan di port http:localhost:${port}`)
// );
...
const korona = require("./lib/korona.js");
const qs = require("./lib/qs.js");
//
const BotName = 'LP BOT'; // Nama Bot Whatsapp
const instagramlu = 'https://www.instagram.com/laksamana97_/'; // Nama Instagramlu cok
const whatsapplu = '082288168806'; // Nomor whatsapplu cok
const kapanbotaktif = '24 Jam'; // Kapan bot lu aktif
const grupch1 = 'https://chat.whatsapp.com/Li88MyeypRAAZDFYhvXLh2'; // OFFICIAL GRUP LU 1
...
conn.on('user-presence-update', json => console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by LKS Project`))
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by LKS Project`)
})
...
conn.sendMessage(id, qs.qs(id, BotName, tampilTanggal, tampilWaktu, instagramlu, whatsapplu, kapanbotaktif, grupch1, grupch2) ,MessageType.text);
}
else if (text == '#korona'){
const corohelp = await get.get('https://covid19.mathdro.id/api/countries/id').json()
var date = new Date();
...
var tampilTanggal = "TANGGAL: " + hari + ", " + tanggal + " " + bulan + " " + tahun;
var tampilWaktu = "JAM: " + jam + ":" + menit + ":" + detik;
conn.sendMessage(id, korona.korona(id, BotName, corohelp, tampilTanggal, tampilWaktu, instagramlu, whatsapplu, kapanbotaktif, grupch1, grupch2) ,MessageType.text);
}
else if (text == '#donate'){
const corohelp = await get.get('https://covid19.mathdro.id/api/countries/id').json()
var date = new Date();
...
const snekfetch = require('snekfetch');
  if (text.includes("#gacha cc"))
   {
    var items = ["cewe sexy", "cewe montik", "cewe bohai"];
    var cewe = items[Math.floor(Math.random() * items.length)];
    var url = "https://api.fdci.se/rep.php?gambar=" + cewe;
